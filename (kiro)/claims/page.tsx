...
const ClaimsPage: React.FC = () => {
  ...
  const fetchClaims = async () => {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5000"}/payroll-tracking/my-claims`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
  ...
  const handleSubmitClaim = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5000"}/payroll-tracking/expense-claims`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
